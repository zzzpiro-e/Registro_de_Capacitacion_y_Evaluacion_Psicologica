...
class AdminAuditoriaScreen extends StatefulWidget {
  ...
  const AdminAuditoriaScreen({super.key, this.onReturnToInicio});
...
class _AdminAuditoriaScreenState extends State<AdminAuditoriaScreen> {
  ...
  final List<Map<String, dynamic>> _filtrosTipo = [
    ...
    {
      'label': 'Usuarios',
      'valor': 'modificacion_usuario',
      'icon': Icons.edit_outlined,
    },
    {
      'label': 'Creaciones',
      'valor': 'creacion_usuario',
    ...
    {
      'label': 'Capacitac.',
      'valor': 'creacion_capacitacion',
      'icon': Icons.school_outlined,
    },
    {
      'label': 'Derivaciones',
      'valor': 'creacion_derivacion',
  ...
  Color _colorPorTipo(String tipo) {
    switch (tipo) {
      ...
      case 'creacion_capacitacion':
        return const Color(0xFF1A73E8);
      case 'modificacion_capacitacion':
        return const Color(0xFF0288D1);
      case 'eliminacion_capacitacion':
        return const Color(0xFFC62828);
      case 'creacion_derivacion':
        return const Color(0xFF00796B);
      case 'actualizacion_derivacion':
  ...
  // Método auxiliar unificado para gestionar la salida
  void _manejarSalida() {
  ...
  Widget build(BuildContext context) {
    // Envolvemos con PopScope usando la lógica unificada para asegurar gestos del SO
    return PopScope(
      canPop:
          widget.onReturnToInicio ==
          null, // Si no hay callback, permite el pop estándar
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final docs = snapshot.data!.docs.where((doc) {
                    ...
                    final tipoOk =
                        _filtroTipo == 'todos' || d['tipo'] == _filtroTipo;
                    final moduloOk =
                        _filtroModulo == 'todos' ||
                        d['modulo'] == _filtroModulo;
  ...
  Widget _eventCard(Map<String, dynamic> data) {
    ...
    final bool tieneDetalle =
        data['camposAntes'] != null || data['camposDespues'] != null;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (tieneDetalle &&
                        (rolAnterior == null || rolNuevo == null)) ...[
  ...
  Widget _emptyState() => Center(
    child: Column(
      ...
      children: [
        ...
        const Text(
          'Los cambios del sistema aparecerán aquí',
...
class _DetalleAuditoria extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic> camposAntes = Map<String, dynamic>.from(
      data['camposAntes'] ?? {},
    );
    final Map<String, dynamic> camposDespues = Map<String, dynamic>.from(
      data['camposDespues'] ?? {},
    );
...
extension _TipoLabelExt on String {
  String get label {
    switch (this) {
      ...
      case 'modificacion_capacitacion':
        return 'Edición Capac.';
      case 'eliminacion_capacitacion':
        return 'Eliminar Capac.';
      case 'creacion_derivacion':
        return 'Nueva Derivación';
      case 'actualizacion_derivacion':
        return 'Actualiz. Derivación';
      default:
        return 'Evento';
    }
  }
